...
if (platform.system() == "Windows"):
    if "64bit" in platform.architecture():
        windll.LoadLibrary(os.getcwd() + r"\libs\windows\x86_64\libusb-1.0.dll")
        # windll.LoadLibrary(r"D:\GlycerineEnema\USB2XXXcode\USB2XXX_Example-master\examples\python\USB2GPIO\USB2GPIO_Test\libs\windows\x86_64\libusb-1.0.dll")
        USB2XXXLib = windll.LoadLibrary(os.getcwd() + r"\libs\windows\x86_64\USB2XXX.dll")
        # USB2XXXLib = windll.LoadLibrary( r"D:\GlycerineEnema\USB2XXXcode\USB2XXX_Example-master\examples\python\USB2GPIO\USB2GPIO_Test\libs\windows\x86_64\USB2XXX.dll")
        print(USB2XXXLib)
    else:
